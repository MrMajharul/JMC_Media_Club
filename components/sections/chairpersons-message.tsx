      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-14 items-start">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="section-pill mb-5">Department Chairperson</span>
            <h2 className="font-montserrat font-bold text-3xl md:text-4xl text-jmc-navy dark:text-white mt-4 mb-8">
              Chairperson&apos;s <span className="text-gradient">Message</span>
            </h2>
            ...
            <div className="relative">
              ...
              <div className="pl-4 space-y-4 border-l-2 border-jmc-green/25">
                {chairperson.message.trim().split('\n\n').map((para, i) => (
            ...
            <div className="mt-10 flex items-center gap-5">
              ...
              <div>
                <p className="font-montserrat font-bold text-jmc-navy dark:text-white">{chairperson.name}</p>
                <p className="text-jmc-green text-sm font-semibold">{chairperson.role}</p>
              </div>
            </div>
          </motion.div>
              ...
              <div className="relative w-full max-w-sm overflow-hidden rounded-3xl bg-gradient-to-br from-jmc-dark-green/10 to-jmc-navy/20 border border-gray-100 dark:border-white/5 shadow-2xl">
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-1">
                    <Award size={14} className="text-jmc-green" />
                    <p className="text-jmc-green text-xs font-bold uppercase tracking-wider">Chief Advisor</p>
                  </div>
                  <h3 className="font-montserrat font-bold text-xl text-jmc-navy dark:text-white">{chairperson.name}</h3>
                  <p className="text-gray-400 text-sm">{chairperson.role}</p>
                </div>
              </div>
